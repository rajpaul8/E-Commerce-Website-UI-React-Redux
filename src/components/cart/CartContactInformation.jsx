        ...
        <>
            <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-4">
                <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                    ...
                    <input type="email" name="email" value={contactForm.email} id='email' required className='text-sm rounded-md border p-1 mt-1 w-full' placeholder=' abc@xyz.com' onChange={handleOnChange} />
                </div>
                <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                    <label htmlFor="phone" className='text-xs flex column font-bold'>Phone number</label>
                    <input type="number" name="phone" value={contactForm.phone} id='phone' required className='w-full text-sm rounded-md border text-md p-1 mt-1' placeholder=' (022) 222 - 22222' onChange={handleOnChange} />
                </div>
            </div>
            ...
            <div className='mt-5'>
                ...
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-4">
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="text" name="country" id='country' value={contactForm.country} className='text-sm rounded-md border w-full p-1 mt-1' placeholder='United States' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                    </div>
                </div>
            ...
            <div className='mt-3'>
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-4">
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="text" name="firstName" id='firstName' value={contactForm.firstName} required className='text-sm rounded-md p-1 mt-1 border w-full' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        <label htmlFor="lastName" className='text-xs flex column '>Last Name</label>
                        <input type="text" name="lastName" id='lastName' value={contactForm.lastName} required className='text-sm rounded-md p-1 mt-1 border w-full' onChange={handleOnChange} />
                    </div>
                </div>
            </div>
            <div className='mt-3'>
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-4">
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="text" name="streetAddress" id='streetAddress' required value={contactForm.streetAddress} className='text-sm p-1 mt-1 rounded-md border w-full' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        <label htmlFor="streetAddress2" className='text-xs flex column '>Street Address 2 (optional)</label>
                        <input type="text" name="streetAddress2" id='streetAddress2' required value={contactForm.streetAddress2} className='text-sm p-1 mt-1 rounded-md border w-full' onChange={handleOnChange} />
                    </div>
                </div>
            </div>
            <div className='mt-3'>
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-4">
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--6 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="text" name="city" id='city' required value={contactForm.city} className='text-sm p-1 mt-1 rounded-md border w-full' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--tablet--3 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="text" name="state" id='state' required value={contactForm.state} className='text-sm p-1 mt-1 rounded-md border w-full' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--tablet--3 aem-GridColumn--phone--12 md:pr-2">
                        <label htmlFor="zip" className='text-xs flex column '>Zip</label>
                        <input type="text" name="zip" id='zip' required value={contactForm.zip} className='text-sm p-1  mt-1 rounded-md border w-full' onChange={handleOnChange} />
                    </div>
                </div>
            </div>
            <div className='flex justify-center mt-7'>
                <button className='continueShoppingButton text-md' onClick={() => updateContactInfo()}> CONTINUE TO SHIPPING METHOD </button>
            </div>
