...
console.log(paymentForm.cardNumber)
            ...
            <div className='mt-3'>
                ...
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-2">
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="text" name="cardName" id='cardName' value={paymentForm.cardName} className='text-sm rounded-md border w-full p-1 mt-1' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                    </div>
                </div>
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-2">
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                        ...
                        <input type="number" name="cardNumber" id='cardNumber' value={paymentForm.cardNumber} className='text-sm rounded-md border w-full p-1 mt-1' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--12 aem-GridColumn--phone--12 md:pr-2">
                    </div>
                </div>
                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 phone_flex_col overflow-x-hidden mt-2">
                    <div className="aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--tablet--6 aem-GridColumn--phone--6 md:pr-2">
                        ...
                        <input type="date" name="expirationDate" id='expirationDate' value={paymentForm.expirationDate} className='text-sm rounded-md border w-full p-1 mt-1' onChange={handleOnChange} />
                    </div>
                    <div className="aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--tablet--6 aem-GridColumn--phone--6 md:pr-2">
                        <label htmlFor="country" className='text-xs flex column font-bold'>CVV</label>
                        <input type="number" name="CVV" id='CVV' value={paymentForm.CVV} className='text-sm rounded-md border w-full p-1 mt-1' onChange={handleOnChange} />
                    </div>
                ...
                <div className='flex justify-center mt-7 mb-7'>
                    <button className='continueShoppingButton text-md' onClick={ handleContinueToReviewOrder}> CONTINUE TO REVIEW ORDER </button>
                </div>
