                    ...
                    <div className="container">
                        ...
                        <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--1 aem-Grid--phone--1 phone_flex_col overflow-y-hidden">
                            <div className="aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--tablet--1 aem-GridColumn--phone--1 md:pr-2">
                                ...
                                {width > 992 ? <>
                                    <div>
                                        <h3 className='pb-3 pt-3'>Filters</h3>
                                        <hr />
                                    ...
                                    <>
                                        <div className="dropdown dropdown-end !h-11 flex justify-center pt-5">
                                            <label tabIndex="0" className=" w-36 flex justify-start "><HiAdjustments className="text-2xl" /> <span className=' font-light underline underline-offset-4 pl-2'>Filter</span>
                            ...
                            <div className="aem-GridColumn aem-GridColumn--default--9 aem-GridColumn--tablet--1 aem-GridColumn--phone--1 pt-1.5">
                                ...
                                <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--12 aem-Grid--phone--12 reverseFlexRow">
                                    <div className='aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--tablet--3 aem-GridColumn--phone--7'>
                                        <div>
                                            <div className="dropdown dropdown-end !h-11 !p-0 ">{width > 992 ? <label tabIndex="0" className="btn btn-outline w-52 flex justify-start font-light">Sort by Price <span className='ml-9 text-2xl'><RiArrowDropDownLine /></span></label> :
                                                ...
                                                <ul tabIndex="0" className="menu dropdown-content p-2 shadow bg-base-100 w-52">
