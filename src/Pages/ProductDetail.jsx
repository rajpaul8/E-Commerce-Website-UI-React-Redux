          ...
          <div className="container">
            ...
            <div className="aem-Grid aem-Grid--default--12 aem-Grid--tablet--1 aem-Grid--phone--12 phone_flex_col overflow-y-hidden">
              ...
              <div className="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--tablet--1 aem-GridColumn--phone--12 md:pl-7">
                ...
                <div className='pt-2'>
                  <hr />
                  <h3 className='text-md py-3'>Quantity</h3>
                  {/* Increment and Decrement Bar */}
                  <div className=' pt-2 flex justify-center md:justify-start'>
                    <button className='decrementer text-4xl pr-2' onClick={() => handleQuantityDecreament()}><AiOutlineMinusCircle /></button>
                    <div>
                      <input type="number" className='quantity-counter text-center' disabled value={quantity} onChange={(e) => setQuantity(e.target.value)} />
                    </div>
                    <button className='text-4xl pl-2 ' onClick={()=>handleQuantityIncreament()}><AiOutlinePlusCircle /></button>
                  </div>
                </div>
                ...
                <div className='flex justify-center md:justify-start space-x-7 pt-7 pl-7'>
                  <div className='text-xl flex'><AiOutlineHeart /><span className='text-base'>Save</span> </div>
                  <div className='text-xl flex p'><AiOutlineShareAlt /><span className='text-base'>Share</span>  </div>
                </div>
              </div>
            </div>
